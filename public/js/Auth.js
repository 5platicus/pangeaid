...
$(document).ready(function() {
    ...
    // resident card - modal plus close on end
    $('#residentCardDone').on('click', function() {
        swal({ title: "Done", text: "Success" })
            .then((res) => {
                let classList = $('#residentCardDone').data('classes').split(/\s+/);
...
function initializeModals() {
    $("#residentCardFormEmpty").animatedModal();
}